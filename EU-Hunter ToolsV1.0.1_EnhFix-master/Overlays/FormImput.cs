...
#pragma warning disable CS1690 // Доступ к члену в "FormMain.repairs" может вызвать исключение времени исполнения, поскольку он является полем класса, который маршалируется по ссылке.
                this.f1.balanceGrid.Rows[0].Cells[1].Value = (object)(this.f1.repairs.ToString() + " PED");
#pragma warning restore CS1690 // Доступ к члену в "FormMain.repairs" может вызвать исключение времени исполнения, поскольку он является полем класса, который маршалируется по ссылке.
            }            
